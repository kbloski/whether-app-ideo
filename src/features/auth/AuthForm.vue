<template>
    <form @submit.prevent="handleSubmit">
        <div class="mb-3">
            ...
            <input type="email" class="form-control" placeholder="Provide login." required v-model.trim="formData.login">
        </div>
        <div class="mb-3">
            <label class="form-label">Password</label>
            <input type="password" class="form-control" placeholder="Provide password." required v-model.trim="formData.password">
        </div>
